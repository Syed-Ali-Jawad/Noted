    ...
    <GradientPage>
      <div className="">
        <form
          ...
          className="shadow-xl relative w-full h-dvh  xs:w-auto xs:min-w-105 xs:h-148.75 bg-white rounded-4xl  overflow-hidden px-4 xs:px-10 flex flex-col justify-center items-center gap-y-8"
        >
